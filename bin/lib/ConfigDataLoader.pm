...
sub calculate_dimensions {
	...
	if (!exists $HashConfi->{global}{colormap_gradient_gap})
	{
		$HashConfi->{global}{colormap_gradient_gap}=4.5;
	}
	...
	my $Legen_WW=($HashConfi->{global}{colormap_gradient_gap}) * $color_gradient_scale;
