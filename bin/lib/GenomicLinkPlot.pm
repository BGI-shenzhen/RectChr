...
sub PTypeLinkPlot
{
	...
	my  ($HashConfi_ref, $ValueToCustomColor_ref,$hashChr_ref,$hashChr2File_ref,$ShowColumn_ref, $FileData_ref, $FileRow_ref,$FileColumn_ref,$ChrArry_ref,$ParaFlag_ref,$widthForPerChr,$ChrMax,$total_chr_length,$MaxGradien,$RegionStart,$bin,$axis_label,$ChrCount,$color_gradient_scale,$chr_spacing,$Bodyheight,$fontsize, $height,$width,$NumberLevel,$NumParaFlag)=@_;
