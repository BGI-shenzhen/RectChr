...
$QUALITY_COLOR_COUNT{"Accent"}=8; $QUALITY_COLOR_COUNT{"Dark2"}=8;   $QUALITY_COLOR_COUNT{"Paired"}=12;   $QUALITY_COLOR_COUNT{"Pastel1"}=9;   $QUALITY_COLOR_COUNT{"Pastel2"}=8;   $QUALITY_COLOR_COUNT{"Set1"}=9;   $QUALITY_COLOR_COUNT{"Set2"}=8;   $QUALITY_COLOR_COUNT{"Set3"}=12;
